...
import industry1 from "@/assets/gallery/industry1.png";
import industry2 from "@/assets/gallery/industry2.png";
import industry3 from "@/assets/gallery/industry3.png";
  ...
  const INDUSTRY_DATA = [
    {
      ...
      features: [
        ...
        "Anniversary gifts for repeat clients",
        "Holiday gifts for top referrers",
        "Closing celebration gifts",
      ],
    },
    {
      title: "Lenders & Financial Professionals",
      image: industry2,
      features: [
        "Mortgage closing gifts",
        "Annual client appreciation",
        "Referral partner recognition",
        "New account bonuses",
      ],
    },
    {
                ...
                {item.features.map((feat, i) => (
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                    >
                      <g clip-path="url(#clip0_845_25807)">
                        <path
