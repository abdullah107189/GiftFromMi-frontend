...
const scheduleSchema = z.object({
  ...
  deliveryDate: z
    .date()
    .refine((date) => !isNaN(date.getTime()), "Delivery date is required"),
...
export default function ScheduleGiftModal({
  isOpen,
  onClose,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[95vh] overflow-y-auto p-0 xl:rounded-3xl md:rounded-2xl rounded-xl border-none">
        <form onSubmit={handleSubmit(onSubmit as any)}>
          <div className="xl:p-8 lg:p-6 md:p-4 p-3 space-y-6">
            <div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <SharedDropdown
                    ...
                    className={cn(
                      "h-12 w-full bg-gray-50 border-gray-100 rounded-xl",
            ...
            <hr className="xl:my-6 md:my-4 my-2 text-[rgba(0,0,0,0.10)]" />
            <div className="md:space-y-4 space-y-2">
              <div className="flex items-center gap-2 text-gray-900  ">
                ...
                >
                  ...
                  />
                  <path
                    d="M2.19336 4.66602L8.00003 7.99935L13.8067 4.66602"
                    stroke="#101828"
                    strokeWidth="1.33333"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    ...
                    render={({ field }) => (
                      <Popover>
                        <PopoverTrigger asChild>
                          <button
                            className={cn(
                              "w-full h-12 text-sm flex items-center cursor-pointer",
            ...
            <div className="md:p-4 p-2 border border-gray-200 rounded-[10px] md:space-y-4 space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <path
                      d="M14.166 1.66602L17.4993 4.99935L14.166 8.33268"
                      stroke="#6A7282"
                      strokeWidth="1.66667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M2.5 9.16667V8.33333C2.5 7.44928 2.85119 6.60143 3.47631 5.97631C4.10143 5.35119 4.94928 5 5.83333 5H17.5"
                      stroke="#6A7282"
                      strokeWidth="1.66667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M5.83333 18.3327L2.5 14.9993L5.83333 11.666"
                      stroke="#6A7282"
                      strokeWidth="1.66667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M17.5 10.834V11.6673C17.5 12.5514 17.1488 13.3992 16.5237 14.0243C15.8986 14.6495 15.0507 15.0007 14.1667 15.0007H2.5"
                      stroke="#6A7282"
                      strokeWidth="1.66667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Automatically schedule this gift to repeat
                    </p>
                  </div>
                </div>
                <Controller
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-[10px]">
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  />
                  <path
                    d="M2.71772 12.771C2.60886 12.8903 2.53702 13.0387 2.51094 13.1981C2.48486 13.3575 2.50566 13.5211 2.57081 13.6688C2.63597 13.8166 2.74267 13.9423 2.87794 14.0306C3.0132 14.1188 3.17121 14.1659 3.33272 14.166H16.6661C16.8276 14.1661 16.9856 14.1192 17.1209 14.0311C17.2563 13.943 17.3631 13.8175 17.4285 13.6698C17.4938 13.5221 17.5148 13.3586 17.4889 13.1992C17.4631 13.0398 17.3914 12.8913 17.2827 12.7718C16.1744 11.6293 14.9994 10.4152 14.9994 6.66602C14.9994 5.33993 14.4726 4.06816 13.5349 3.13048C12.5972 2.1928 11.3255 1.66602 9.99939 1.66602C8.67331 1.66602 7.40154 2.1928 6.46386 3.13048C5.52618 4.06816 4.99939 5.33993 4.99939 6.66602C4.99939 10.4152 3.82356 11.6293 2.71772 12.771Z"
                    stroke="#6A7282"
                    strokeWidth="1.66667"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Notify recipient when gift is scheduled
                  </p>
                </div>
              </div>
              <Controller
            ...
            <div className="bg-[#EFF6FF] border border-[#BEDBFF] md:p-4 p-2 rounded-[10px] flex gap-3">
              ...
              <div className="text-xs text-[#1C398E] leading-relaxed">
                ...
                The gift will be automatically processed and sent at the
                scheduled date and time. You'll receive a confirmation email
                once the gift is dispatched.
              </div>
            </div>
          </div>

          <div className="flex items-center justify-end gap-3 xl:p-6 md:p-4 p-2">
