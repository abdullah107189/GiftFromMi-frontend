    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="xl:min-w-[600px] w-full p-0 rounded-2xl border-none shadow-lg bg-white">
        ...
        <form
          ...
          id="exportForm"
          className=" xl:pl-6 xl:pr-6  pl-4 pr-4"
        >
          ...
          <div className="mb-4">
            <Label className="mb-2.5 text-[14px] font-normal text-gray-700">
              Select range
            </Label>
            <Controller
              name="range"
                ...
                >
                  <div className="flex items-center space-x-3">
                    <RadioGroupItem
                      value="all"
                      id="all"
                      className="active:border-primary focus:border-primary text-primary"
                    />
                    <Label
                      htmlFor="all"
                      className="text-sm font-normal text-[#1A1C21] cursor-pointer"
                    >
                      All Orders
                    </Label>
                  </div>
        ...
        <div className="flex items-center justify-end gap-3 border-t xl:p-[24px] p-4">
          ...
          <Button form="exportForm" variant={"ModalActive"} type="submit">
            Export
          </Button>
        </div>
      </DialogContent>
