...
export default function StatCard({ data }: StatCardProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-start md:gap-2 flex-1 border border-gray-200 xl:p-[24px_24px_24px_14px] md:p-4 p-2 shadow-[0_0_40px_0_rgba(213,161,91,0.40)_inset] bg-background md:rounded-2xl rounded-xl",
      )}
    >
