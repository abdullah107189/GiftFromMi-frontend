...
export default function ImportRecipientsModal({
  isOpen,
  onClose,
}: {
  isOpen: boolean;
        ...
        >
          ...
          <div className="bg-[#F9FAFB] rounded-2xl p-4">
            ...
            <ul className="space-y-2 text-xs text-gray-500 list-disc list-inside">
              <li>
                File must include headers: First Name, Last Name, Email, Phone,
                Company
              </li>
            ...
            <button
              type="button"
              className="mt-2.5 text-primary text-sm cursor-pointer hover:underline"
            >
