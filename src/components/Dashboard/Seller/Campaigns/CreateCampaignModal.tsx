...
export const FormLabel = ({ children }: { children: React.ReactNode }) => (
  <label className="block text-[14px] text-gray-500 mb-1.5">{children}</label>
);
      ...
      <DialogContent className="xl:min-w-[750px] max-h-[90vh] overflow-y-auto p-0 rounded-3xl border-none bg-white [&>button]:hidden">
        <DialogHeader className="md:p-8 p-4 pb-4">
          ...
          <DialogDescription className="text-[14px] text-gray-500">
            Set up a new automated gift campaign
          </DialogDescription>
        </DialogHeader>

        <form
          onSubmit={handleSubmit(onSubmit)}
          className="xl:p-8 md:p-6 p-4 pt-0 space-y-6"
        >
          <div>
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  className={cn(
                    "placeholder:text-gray-400 h-12 bg-gray-50 border-gray-100 rounded-xl",
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Popover>
                    ...
                    <PopoverContent
                      className="w-auto p-0 rounded-2xl border-gray-100"
                      align="start"
                    >
                      <Calendar
                        mode="single"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <SharedDropdown
                    ...
                    className={cn(
                      "h-12 bg-gray-50 border-gray-100 rounded-xl w-full",
          ...
          <div>
            ...
            />
            {errors.gift && (
              <p className="text-xs text-red-500 mt-1">{errors.gift.message}</p>
            )}
          </div>
          ...
          <div className="bg-[#FAF5FF] p-4 rounded-lg">
            <p className="text-xs text-[#4A5565]">
              You can edit campaign details and pause/resume campaigns at any
              time from the Campaigns page.
            </p>
          </div>
