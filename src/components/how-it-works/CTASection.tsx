      ...
      <div className="max-w-container mx-auto px-3">
        <div className="relative rounded-2xl">
          <div className="relative z-10 flex flex-col items-center text-center px-6">
            <h2 className=" text-2xl md:text-4xl xl:text-5xl font-semibold text-white xl:mb-6 mb-3 leading-[1.1]">
              Ready to Send the <br className="hidden md:block" /> Perfect Gift?
            </h2>

            <p className="text-gray-300 xl:text-xl md:text-lg text-sm max-w-xl md:mb-10 mb-3 leading-relaxed">
